            ...
            <table id="basic-table" class="table table-bordered mb-0" role="grid">
                ...
                <tbody>
                    ...
                    <tr class="text-center">
                        ...
                        <td>
                            <h6 class="">
                                <a class="text-dark" href="/admin/laboratorium/<?php echo e($lab->name); ?>"><?php echo e($lab->name); ?></a>
                            </h6>
                        </td>
                        <td class="text-start">
                            ...
                            <ul>
                                <li>
                                    <a class="text-dark" href="/admin/dosen/<?php echo e($user->nip); ?>"><?php echo e($user->name); ?></a>
                                </li>
                            </ul>
                            <?php endif; ?>
                            <?php endif; ?>
                        ...
                        <td class="text-start">
                            ...
                            <ul>
                                <li>
                                    <a class="text-dark" href="/admin/laboran/<?php echo e($user->nip); ?>"><?php echo e($user->name); ?></a>
                                </li>
                            </ul>
                            <?php endif; ?>
                            <?php endif; ?>
                        ...
                        <td>
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-warning btn-sm d-block m-1 rounded" href="/admin/laboratorium/<?php echo e($lab->name); ?>">
                                ...
                                <a class="btn btn-primary btn-sm d-block m-1 rounded" href="/admin/laboratorium/<?php echo e($lab->name); ?>/edit">
                                    <svg width="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
...
<?php echo $__env->make('template.v_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project Laravel\labterpadu\resources\views//superadmin/lab.blade.php ENDPATH**/ ?>