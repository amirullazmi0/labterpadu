...
<div class="card">
    <div class="card-body">
        ...
        <div class="tambah-dosen">
            <form action="/registerlaboran" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-lg-6">
...
unset($__errorArgs, $__bag); ?>" name="name" sid="name"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <input type="text" class="" name="level" id="name" value="2" required="" hidden>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="password" class="form-label">Lab</label>
                            <select class="form-select <?php $__errorArgs = ['lab_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="address"
                            id="exampleFormControlTextarea1" rows="3"><?php echo e(old('address')); ?></textarea>
...
<?php echo $__env->make('template.v_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project Laravel\labterpadu\resources\views//superadmin/add_laboran.blade.php ENDPATH**/ ?>