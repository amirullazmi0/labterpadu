...
<div class="card">
    <div class="card-body">
        ...
        <a class="btn btn-sm btn-success" href="/aadmin/laboratorium/add-alat">
            ...
            <table id="basic-table" class="table table-bordered mb-0" role="grid">
                ...
                <tbody>
                    ...
                    <tr class="text-center">
                        ...
                        <td>
                            <a href="/aadmin/laboratorium/alat/<?php echo e($alat->name); ?>">
                                <img class=" img-fluid" src="<?php echo e(asset('storage/'. $alat->photos)); ?>" alt="" style="max-height: 100px;">
                            </a>
                        </td>
                        <td>
                            <h6 class="">
                        ...
                        <td>
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-warning btn-sm d-block m-1 rounded" href="/aadmin/laboratorium/alat/<?php echo e($alat->name); ?>">
                                    <svg width=" 25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a class="btn btn-primary btn-sm d-block m-1 rounded"
                                    href="/aadmin/laboratorium/alat/<?php echo e($alat->name); ?>/edit">
                                    <svg width="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                <a class="btn btn-danger btn-sm d-block m-1 rounded" onclick="return confirm('Are you sure to delete ?')"
                                    href="/aadmin/laboratorium/alat/delete/<?php echo e($alat->id); ?>">
                                    <svg width="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
        ...
        <?php else: ?>
        <h3 class="text-center mt-5 mb-5">Tidak Ada Data alat</h3>
        <?php endif; ?>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template.v_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project Laravel\labterpadu\resources\views//admin/alat.blade.php ENDPATH**/ ?>