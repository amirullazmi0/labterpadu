...
<div class="card">
    <div class="card-body">
        ...
        <a class="btn btn-sm btn-success" href="/admin/add-p-ruangan">
        ...
        <div class="table-responsive mt-4 text-center">
            <table id="basic-table" class="table table-bordered mb-0" role="grid">
                ...
                <tbody>
                    <?php $__currentLoopData = $p_ruangan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p_ruangan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="text-center">
                        ...
                        <td>
                            <?php echo e($p_ruangan->ruangan->name); ?>

                        </td>
                        <td>
                            <p class="pt-3" style="font-size: small;">
                                <?php echo e(date('d F Y', strtotime($p_ruangan->date_start))); ?>

                                <?php if($p_ruangan->date_end != null): ?>
                                - <?php echo e(date('d F Y', strtotime($p_ruangan->date_end))); ?>
                        ...
                        <td>
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-warning btn-sm d-block m-1 rounded" href="/admin/p-ruangan/<?php echo e($p_ruangan->id); ?>">
                                    <svg width="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a class="btn btn-primary btn-sm d-block m-1 rounded" href="/admin/p-ruangan/<?php echo e($p_ruangan->id); ?>/edit">
                                    <svg width="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                <a class="btn btn-danger btn-sm d-block m-1 rounded" onclick="return confirm('Are you sure to delete ?')"
                                    href="/admin/p-ruangan/delete/<?php echo e($p_ruangan->id); ?>">
                                    <svg width="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <?php if($p_ruangan->berkas): ?>
                            <div class="d-block justify-content-center">
                                <a class="btn btn-secondary btn-sm d-block m-1 rounded" onclick="return confirm('Are you sure to delete ?')"
                                    href="/admin/p-ruangan/delete/<?php echo e($p_ruangan->id); ?>">
                                    Download File
                                </a>
                            </div>
        ...
        <?php else: ?>
        <h3 class="text-center mt-5 mb-5">Tidak Ada Data Peminjaman</h3>
        <?php endif; ?>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template.v_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project Laravel\labterpadu\resources\views//superadmin/p_ruangan.blade.php ENDPATH**/ ?>