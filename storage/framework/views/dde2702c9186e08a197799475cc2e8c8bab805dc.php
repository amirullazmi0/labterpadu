...
<div class="index">
    <div class="row">
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <h3 class="text-center"><?php echo e($jumlah_dosen); ?></h3>
                    <div class="d-flex justify-content-end mt-3">
                        <a class="btn btn-warning btn-sm d-block m-1" href="/dosen/laboratorium">
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    <p class="text-center">Laboran</p>
                    <hr>
                    <h3 class="text-center"><?php echo e($jumlah_laboran); ?></h3>
                    <div class="d-flex justify-content-end mt-3">
                        <a class="btn btn-warning btn-sm d-block m-1" href="">
                            <svg width="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M15.7161 16.2234H8.49609" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                <path d="M15.7161 12.0369H8.49609" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                <path d="M11.2521 7.86011H8.49707" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <h3 class="text-center"><?php echo e($jumlah_lab); ?></h3>
                    <div class="d-flex justify-content-end mt-3">
                        <a class="btn btn-warning btn-sm d-block m-1" href="">
                            <svg width="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M15.7161 16.2234H8.49609" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    <p class="text-center">Ruangan</p>
                    <hr>
                    <h3 class="text-center"><?php echo e($jumlah_ruangan); ?></h3>
                    <div class="d-flex justify-content-end mt-3">
                        <a class="btn btn-warning btn-sm d-block m-1" href="">
                            <svg width="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M15.7161 16.2234H8.49609" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
...
<?php echo $__env->make('template.v_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project Laravel\labterpadu\resources\views//superadmin/index.blade.php ENDPATH**/ ?>