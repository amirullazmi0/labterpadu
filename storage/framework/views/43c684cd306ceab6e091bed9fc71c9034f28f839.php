...
<div class="card">
    <div class="card-body">
        ...
        <a class="btn btn-sm btn-success" href="/aadmin/laboratorium/add-p-alat">
        ...
        <div class="table-responsive mt-4 text-center">
            <table id="basic-table" class="table table-bordered mb-0" role="grid">
                ...
                <tbody>
                    <?php $__currentLoopData = $p_alat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p_alat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="text-center">
                        ...
                        <td>
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-warning btn-sm d-block m-1 rounded" href="/aadmin/laboratorium/p-alat/<?php echo e($p_alat->id); ?>">
                                    <svg width="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a class="btn btn-primary btn-sm d-block m-1 rounded"
                                    href="/aadmin/laboratorium/p-alat/<?php echo e($p_alat->id); ?>/edit">
                                    <svg width="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <div class="d-block justify-content-center">
                                <a class="btn btn-secondary btn-sm d-block m-1 rounded" href=" <?php echo e(asset('storage/'. $p_alat->berkas)); ?>">
                                    Download File
                                </a>
                            </div>
                            <?php endif; ?>
...
<?php echo $__env->make('template.v_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project Laravel\labterpadu\resources\views//admin/p_alat.blade.php ENDPATH**/ ?>