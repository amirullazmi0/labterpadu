<aside class="sidebar sidebar-default navs-rounded-all ">
    <div class="sidebar-header d-flex align-items-center justify-content-start">
        ...
        <a href="/admin" class="navbar-brand">
            <img class="img-fluid" width="30" src="/img/untan-logo.png" alt="">
            <h4 class="logo-title">LAB TERPADU</h4>
        </a>
        <?php else: ?>
        <a href="/aadmin" class="navbar-brand">
            <img class="img-fluid" width="30" src="/img/untan-logo.png" alt="">
            <h4 class="logo-title">LAB TERPADU</h4>
        </a>
        <?php endif; ?>
        <div class="sidebar-toggle d-block d-sm-none" data-toggle="sidebar" data-active="true">
            <i class="icon">
    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                <li class="nav-item">
                    <a class="nav-link <?php echo e(($active === 'dashboard') ? 'active' : ''); ?>" aria-current="page" href="/admin">
                        <i class="icon">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(($active === 'lab') ? 'active' : ''); ?>" aria-current="page" href="/admin/laboratorium">
                        <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <span class="item-name">Lab</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(($active === 'dosen') ? 'active' : ''); ?>" aria-current="page" href="/admin/dosen">
                        <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    stroke="currentColor" stroke-width="1.42857" stroke-linecap="round" stroke-linejoin="round"></path>
                            </svg>
                        </i>
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(($active === 'laboran') ? 'active' : ''); ?>" aria-current="page" href="/admin/laboran">
                        <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <span class="item-name">Laboran</span>
                    </a>
                </li>
                <li class="nav-item">
                    ...
                    <ul class="sub-nav collapse" id="horizontal-menu" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(($active === 'ruangan') ? 'active' : ''); ?>" href="/admin/ruangan">
                                <i class="icon">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(($active === 'p_ruangan') ? 'active' : ''); ?>" href="/admin/p-ruangan">
                                <i class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <span class="item-name">Peminjaman Ruangan</span>
                            </a>
                        </li>
                    </ul>
                </li>
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                <li class="nav-item">
                    <a class="nav-link <?php echo e(($active === 'dashboard') ? 'active' : ''); ?>" aria-current="page" href="/aadmin">
                        <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4"
                                    d="M16.0756 2H19.4616C20.8639 2 22.0001 3.14585 22.0001 4.55996V7.97452C22.0001 9.38864 20.8639 10.5345 19.4616 10.5345H16.0756C14.6734 10.5345 13.5371 9.38864 13.5371 7.97452V4.55996C13.5371 3.14585 14.6734 2 16.0756 2Z"
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(($active === 'lab') ? 'active' : ''); ?>" aria-current="page" href="/aadmin/laboratorium">
                        <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M14.7379 2.76175H8.08493C6.00493 2.75375 4.29993 4.41175 4.25093 6.49075V17.2037C4.20493 19.3167 5.87993 21.0677 7.99293 21.1147C8.02393 21.1147 8.05393 21.1157 8.08493 21.1147H16.0739C18.1679 21.0297 19.8179 19.2997 19.8029 17.2037V8.03775L14.7379 2.76175Z"
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#horizontal-menu" role="button" aria-expanded="false"
                        ...
                        <span class="item-name">Alat Lab</span>
                        <i class="right-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                            </svg>
                    ...
                    <ul class="sub-nav collapse" id="horizontal-menu" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(($active === 'alat') ? 'active' : ''); ?>" href="/aadmin/laboratorium/alat">
                                <i class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <i class="sidenav-mini-icon"> R </i>
                                <span class="item-name"> Daftar Alat </span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(($active === 'p_alat') ? 'active' : ''); ?>" href="/aadmin/laboratorium/p-alat">
                                <i class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <i class="sidenav-mini-icon"> P </i>
                                <span class="item-name">Peminjaman Alat</span>
                            </a>
                        </li>
                    </ul>
                </li>
...
</aside><?php /**PATH D:\Project Laravel\labterpadu\resources\views/template/v_sidebar.blade.php ENDPATH**/ ?>