...
<div class="card p-3">
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-8">
                <p>
                    {{ $p_ruangan->time_start }}
                    @if($p_ruangan->time_end != null)
                    - {{ $p_ruangan->time_end }}
                    @endif
                </p>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-8">
                @if ($p_ruangan->berkas)
                <a href="{{ asset('storage/'. $p_ruangan->berkas) }}">
                    <small>{{ asset('storage/'. $p_ruangan->berkas) }}</small>
                </a>
                @else
                <p>-</p>
                @endif
        ...
        <div class="d-flex justify-content-end">
            <a class="btn btn-primary btn-sm m-1 rounded" href="/admin/p-ruangan/{{ $p_ruangan->id }}/edit">
