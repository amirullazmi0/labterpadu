            ...
            <table id="basic-table" class="table table-bordered mb-0" role="grid">
                ...
                <tbody>
                    ...
                    <tr class="text-center">
                        ...
                        <td>
                            <h6 class="">
                                <a class="text-dark" href="/admin/laboran/{{ $user->name }}">{{ $user->name }}</a>
                            </h6>
                        </td>
                        <td>
                        ...
                        <td>
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-warning btn-sm d-block m-1 rounded" href="/admin/laboran/{{ $user->name }}">
                                    <svg width="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a class="btn btn-primary btn-sm d-block m-1 rounded" href="/admin/laboran/{{ $user->name }}/edit">
                                    <svg width="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
