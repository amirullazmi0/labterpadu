    ...
    <div class="card-body">
        ...
        <div class="table-responsive mt-4 text-center">
            <table id="basic-table" class="table table-bordered mb-0" role="grid">
                ...
                <tbody>
                    @foreach($p_ruangan as $p_ruangan)
                    <tr class="text-center">
                        ...
                        <td>
                            {{ $p_ruangan->ruangan->name}}
                        </td>
                        <td>
                            <p class="pt-3" style="font-size: small;">
                                {{ date('d F Y', strtotime($p_ruangan->date_start)); }}
                                @if($p_ruangan->date_end != null)
                                - {{ date('d F Y', strtotime($p_ruangan->date_end)); }}
                                @endif
                            </p>
                        </td>
                        <td>
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-warning btn-sm d-block m-1 rounded" href="/admin/p-ruangan/{{ $p_ruangan->id }}">
                                    <svg width="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a class="btn btn-primary btn-sm d-block m-1 rounded" href="/admin/p-ruangan/{{ $p_ruangan->id }}/edit">
                                    <svg width="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                <a class="btn btn-danger btn-sm d-block m-1 rounded" onclick="return confirm('Are you sure to delete ?')"
                                    href="/admin/p-ruangan/delete/{{ $p_ruangan->id }}">
                                    <svg width="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
