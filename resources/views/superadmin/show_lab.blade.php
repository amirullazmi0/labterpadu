...
<div class="card">
    <div class="card-body">
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="text-center">
                    @if ($lab->photo)
                    <img class="img-fluid" style="max-height: 300px;" src="{{ asset('storage/'.$lab->photo) }}" alt="">
                    @else
                    <img class="img-fluid" src="/img/labterpadu.jpg" style="max-height: 300px;" alt="">
                    @endif
                    <h3 class="m-3">{{ $lab->name }}</h3>
                </div>
                <hr>
            </div>
            <div class="col-lg-8">
        ...
        <div class="d-flex justify-content-end">
            <a class="btn btn-primary btn-sm m-1 rounded" href="/admin/laboratorium/{{ $lab->name }}/edit">
