                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" sid="name"
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select class="form-select @error('lab_id') is-invalid @enderror" name="lab_id" id="exampleFormControlSelect1">
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control  @error('address') is-invalid @enderror" name="address"
                            id="exampleFormControlTextarea1" rows="3">{{ old('address') }}</textarea>
                        @error('address')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
