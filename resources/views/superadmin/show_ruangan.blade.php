...
<div class="card">
    <div class="card-body">
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="text-center">
                    @if ($ruangan->photos)
                    <img class="img-fluid" style="max-height: 300px;" src="{{ asset('storage/'.$ruangan->photos) }}" alt="">
                    @else
                    <img class="img-fluid" src="/img/labterpadu.jpg" style="max-height: 300px;" alt="">
                    @endif
                    <h3 class="m-3">{{ $ruangan->name }}</h3>
                </div>
                <hr>
            </div>
            <div class="col-lg-8">
        ...
        <div class="d-flex justify-content-end">
            <a class="btn btn-primary btn-sm m-1 rounded" href="/admin/ruangan/{{ $ruangan->id }}/edit">
            ...
            <a class="btn btn-danger btn-sm m-1 rounded" onclick="return confirm('Are you sure to delete ?')"
                href="/admin/ruangan/delete/{{ $ruangan->id }}">
                <svg width="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
