            ...
            <table id="basic-table" class="table table-bordered mb-0" role="grid">
                ...
                <tbody>
                    ...
                    <tr class="text-center">
                        ...
                        <td>
                            <a href="/aadmin/laboratorium/alat/{{ $alat->name }}">
                                <img class=" img-fluid" src="{{ asset('storage/'. $alat->photos) }}" alt="" style="max-height: 100px;">
                            </a>
                        </td>
                        <td>
                            <h6 class="">
                                <a class="text-dark" href="/aadmin/laboratorium/alat/{{ $alat->name }}">{{ $alat->name }}</a>
                            </h6>
                        </td>
                        <td>
                            <div class="d-flex justify-content-center">
                                <div class="bulat"
                                    style="height: 40px; width: 40px;border-radius: 20px;background-color: {{ $alat->color }}">
                                </div>
                            </div>
                        </td>
                        <td>
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-warning btn-sm d-block m-1 rounded" href="/aadmin/laboratorium/alat/{{ $alat->name }}">
                                    <svg width=" 25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a class="btn btn-primary btn-sm d-block m-1 rounded"
                                    href="/aadmin/laboratorium/alat/{{ $alat->name }}/edit">
                                    <svg width="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                <a class="btn btn-danger btn-sm d-block m-1 rounded" onclick="return confirm('Are you sure to delete ?')"
                                    href="/aadmin/laboratorium/alat/delete/{{ $alat->id }}">
                                    <svg width="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
