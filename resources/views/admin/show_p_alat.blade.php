...
<div class="card p-3">
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-8">
                @if ($p_alat->berkas)
                <a href="{{ asset('storage/'. $p_alat->berkas) }}">
                    <small>{{ asset('storage/'. $p_alat->berkas) }}</small>
                </a>
                @else
                <p>-</p>
                @endif
        ...
        <div class="d-flex justify-content-end">
            <a class="btn btn-primary btn-sm m-1 rounded" href="/aadmin/laboratorium/p-alat/{{ $p_alat->id }}/edit">
