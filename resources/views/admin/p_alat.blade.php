                    ...
                    <tr class="text-center">
                        ...
                        <td>
                            <p class="pt-3" style="font-size: small;">
                                {{ date('d F Y', strtotime($p_alat->date_start)); }}
                                @if($p_alat->date_end != null)
                                - {{ date('d F Y', strtotime($p_alat->date_end)); }}
                                @endif
                            </p>
                        </td>
                        <td>
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-warning btn-sm d-block m-1 rounded" href="/aadmin/laboratorium/p-alat/{{ $p_alat->id }}">
                                    <svg width="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a class="btn btn-primary btn-sm d-block m-1 rounded"
                                    href="/aadmin/laboratorium/p-alat/{{ $p_alat->id }}/edit">
                                    <svg width="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                <a class="btn btn-danger btn-sm d-block m-1 rounded" onclick="return confirm('Are you sure to delete ?')"
                                    href="/aadmin/laboratorium/p-alat/delete/{{ $p_alat->id }}">
                                    <svg width="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <div class="d-block justify-content-center">
                                <a class="btn btn-secondary btn-sm d-block m-1 rounded" href=" {{ asset('storage/'. $p_alat->berkas) }}">
                                    Download File
                                </a>
                            </div>
                            @endif
