            ...
            <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                <li class="nav-item dropdown">
                    <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        @if (auth()->user()->photo)
                        <img class="img-fluid" style="max-height: 40px" src="{{ asset('storage/'. auth()->user()->photo) }}" alt="">
                        @else
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        @if (auth()->user()->level == "0")
                        <li><a class="dropdown-item" href="/admin/profil/{{ auth()->user()->name }}">Profil</a></li>
                        @else
                        <li><a class="dropdown-item" href="/aadmin/profil/{{ auth()->user()->name }}">Profil</a></li>
                        @endif
                        <hr>
